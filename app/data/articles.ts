...
export const articles: Article[] = [
  {
    ...
    content: `
      ...
      <p>Prvá skladba bola oficiálne predstavená 1. marca a nesie názov Som tu pre teba. „Možno sa to môže niekomu zdať ako klišé, ale podľa nás je táto téma extrémne aktuálna. Žijeme čudnú dobu, ktorá je absolútne neistá a práve teraz je viac ako dôležité mať pri sebe blízkeho človeka", povedal o téme nového singla Martin Hudák. Skladbu Som tu pre teba si môžete vypočuť na tomto linku: <a href="https://www.youtube.com/watch?v=gUYosHr6c-s" target="_blank" rel="noopener noreferrer" class="text-[#ff0000] hover:text-[#ff3333]">https://www.youtube.com/watch?v=gUYosHr6c-s</a></p>
      
      <p>Skladby v rámci 5 in 5 challenge budú vychádzať v mesačných intervaloch. Posledná, špeciálna skladba, má naplánovaný dátum vydania na 1. júla. „Táto pieseň má pre nás výnimočný význam. Naspieval nám ju legendárny Spoko z kapely Smola a Hrušky, čo je pre nás obrovská česť. Veríme, že sa bude ľuďom páčiť", uzatvára Martin Hudák.</p>
