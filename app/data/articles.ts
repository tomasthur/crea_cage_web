...
export const articles: Article[] = [
  {
    ...
    excerpt: 'Gelnická rocková kapela Crea Cage chýbala na koncertných pódiách dlhých päť rokov, počas ktorých netvorila ani nové piesne. S príchodom roka 2025 však chalani oznámili svoj návrat a fanúšikom sľubujú ambicióznu výzvu – päť nových skladieb za 50 dní.',
    content: `
      <p>Gelnická rocková kapela Crea Cage chýbala na koncertných pódiách dlhých päť rokov, počas ktorých netvorila ani nové piesne. S príchodom roka 2025 však chalani oznámili svoj návrat a fanúšikom sľubujú ambicióznu výzvu – päť nových skladieb za 50 dní.</p>
      ...
      <p>Prvá skladba bude oficiálne predstavená 1. marca, ďalšie budú pribúdať v desaťdňových intervaloch. Posledná, špeciálna skladba, má naplánovaný dátum vydania na 10. apríla. „Táto pieseň má pre nás výnimočný význam. Naspieval nám ju legendárny Spoko z kapely Smola a Hrušky, čo je pre nás obrovská česť. Veríme, že sa bude ľuďom páčiť," uzatvára Martin Hudák.</p>
      
      <p>Či sa Crea Cage podarí túto výzvu splniť, ukážu najbližšie týždne.</p>
    `,
    image: '/images/5_in_50.png',
    date: '16 JAN 2026',
  },
  {
    id: '1',
    slug: 'mame-novy-web',
    title: 'Máme nový web',
    excerpt: 'Reštart kapely so sebou prináša nie len 5 in 50 challenge, ale aj nový web, kde Vám budeme pravidelne prinášať tie najnovšie informácie o koncertoch, či dianí v kapele.',
    content: `
      <p>Reštart kapely so sebou prináša nie len 5 in 50 challenge, ale aj nový web, kde Vám budeme pravidelne prinášať tie najnovšie informácie o koncertoch, či dianí v kapele.</p>
